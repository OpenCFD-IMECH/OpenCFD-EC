!  PLOT3D mesh file convert
!  3D --> 2D  or 2D---> 3D ;    unformatted <------>  formatted
!  Ver 1.1  , 2016-9-18
  module mesh
    implicit none
...
!-----------------------------------------------------------
    ...
    print*,   "          4:  2D formatted to unformatted ;   5:  2D unformated to formatted"
    print*,   "          6:  3D formatted to unformatted ;   7:  3D unformated to formatted"
    read(*,*) Iflag_convert
